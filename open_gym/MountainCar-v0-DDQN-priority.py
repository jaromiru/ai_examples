...
# with Double DQN and priority experience replay
#
...
class Brain:
    ...
    def _createModel(self):
        ...
        model.add(Dense(output_dim=192, activation='relu', input_dim=stateCnt))
        model.add(Dense(output_dim=192, activation='relu'))
...
class Memory:   # stored as ( s, a, r, s_ )
    ...
    def __init__(self, capacity):
        self.tree = utils.SumTree(capacity)

    def add(self, sample):                
        self.tree.add(10, sample) 
